source("bivariate_all_function_modified.R")
library(ddalpha)
...
Covariates = read.table("C:\\Users\\indra\\Dropbox\\Debdeep_Neuro\\Paper_final\\Data\\Covariates.txt")
Response = read.table("C:\\Users\\indra\\Dropbox\\Debdeep_Neuro\\Paper_final\\Data\\Response.txt")
...
Gamma1 = kronecker(CovMat.2(test_knots, nu= 2.5, sigma = 2,theta = .10),
...
par(mfrow=c(2,3))
location.1<-sort(sample(1:K,10,replace = F))
