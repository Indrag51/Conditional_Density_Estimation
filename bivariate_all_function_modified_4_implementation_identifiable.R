source("/Users/indrajit_ghosh/Dropbox/Debdeep_Neuro/Paper_final/code/Github/model_main/bivariate_all_function_modified_identifiable.R")
library(ddalpha)
...
#save("TT", file = "Case1_n_50_k_5.Rdata")
